...
class LCD
{
  ...
  void drawBitmapToScreen(int8_t X,int8_t Y,int8_t Width,int8_t Height,const uint8_t *Bitmap);
  void drawBitmapToScreenPGM(int8_t X,int8_t Y,int8_t Width,int8_t Height,const uint8_t *Bitmap);
